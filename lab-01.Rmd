...
**Not Availabe. this happens because some of the data for the number of visitors in 2021 is not available, and so is not an integer that can be ran through the mean and median functions.**
...
```
```{r}
created_at <- (1.499812e+12)/1000


dt_created_at <- as.POSIXct(created_at, origin = "1970-01-01")
